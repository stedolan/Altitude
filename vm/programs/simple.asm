...
Function <sum>:
 Arguments:
  signed int x declared in @"testorig.c":13:185
 Local variables:
  struct somestruct s declared in @"testorig.c":13:185
  signed int i declared in @"testorig.c":13:185
 Constants:
  0: signed int =  0
  1: signed int =  0
  2: signed int =  1
...
Function <main>:
 Arguments:
 Local variables:
  signed int tmp declared in @"testorig.c":22:325
 Constants:
  0: signed int =  40
 Code:
  ...
  0006: PTR_DEREF
  0007: FUNC_CALL 10240
  0009: ARITH_PLUS
  0010: PTR_DEREF
  0011: FUNC_RETURN
  0012: FUNC_RETURN_NONE
