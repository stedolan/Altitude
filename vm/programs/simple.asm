...
Function <sum>:
 Arguments:
  signed int x declared in @"simple.c":10:159
 Local variables:
  struct somestruct s declared in @"simple.c":10:159
  signed int i declared in @"simple.c":10:159
 Constants:
  0: signed int =  0
  1: signed int =  0
  2: signed int =  1
 Code:
  ...
  @"simple.c":12:200              0008: PTR_ASSIGN
                                  0009: VAR_LOAD_LOCAL 2
                                  0011: VAR_LOAD_CONSTANT 1
  @"simple.c":13:226              0013: PTR_ASSIGN
                                  ...
                                  0020: REL_LT[PS_INT]
                                  0021: GOTO_COND 6 (->27)
  @"simple.c":13:221              0023: GOTO_ALWAYS 33 (->56)
...
Function <main>:
 ...
 Code:
                                  ...
                                  0006: PTR_DEREF
  @"simple.c":20:313              0007: FUNC_CALL 1
                                  0009: VAR_LOAD_LOCAL 0
                                  0011: PTR_DEREF
  @"simple.c":20:313              0012: FUNC_RETURN
